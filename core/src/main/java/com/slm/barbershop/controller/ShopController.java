...
public class ShopController {
    ...
    public ApiResponse<ShopResponse> create(@RequestBody ShopRequest request) {
        ...
        return ApiResponse.success(shopConverter.toResponse(shop));
    }
    ...
    public ApiResponse<PageResult<ShopResponse>> page(ShopQuery query) {
        Long userId = UserContext.getUser().getId();
        return ApiResponse.success(PageResult.map(shopService.page(query, userId), shopConverter::toResponse));
    }
    ...
    public ApiResponse<List<ShopTransactionRecentVO>> recentTransactions(
        ...
        return ApiResponse.success(memberTransactionService.listRecentByShopId(id, limit));
    }
    ...
    public ApiResponse<ShopOverviewStatsVO> statsOverview() {
        Long userId = UserContext.getUser().getId();
        return ApiResponse.success(shopService.overviewStats(userId));
    }
    ...
    public ApiResponse<PageResult<ShopStatsVO>> statsList(ShopStatsQuery query) {
        Long userId = UserContext.getUser().getId();
        return ApiResponse.success(shopService.statsPage(query, userId));
    }
