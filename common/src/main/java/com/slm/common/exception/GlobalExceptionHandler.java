...
public class GlobalExceptionHandler {
    ...
    public ApiResponse<Void> handler(BindException e) {
        ...
        return ApiResponse.failure(ResultStatus.BAD_REQUEST, fieldError.getDefaultMessage());
    }
    ...
    public ApiResponse<Void> handler(ConstraintViolationException e) {
        ...
        return ApiResponse.failure(ResultStatus.BAD_REQUEST, constraintViolations.iterator().next().getMessage());
    }
    ...
    public ApiResponse<Void> handler(MaxUploadSizeExceededException e) {
        ...
        return ApiResponse.failure(ResultStatus.FILE_SIZE_EXCEEDED, "文件大小超过限制(20MB)");
    }
